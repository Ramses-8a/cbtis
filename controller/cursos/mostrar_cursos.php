...
$sql = $connect->prepare("SELECT c.*, tc.nom_tipo, l.nom_lenguaje FROM cursos c LEFT JOIN tipo_cursos tc ON c.fk_tipo_curso = tc.pk_tipo_curso LEFT JOIN lenguajes l ON c.fk_lenguaje = l.pk_lenguaje");
