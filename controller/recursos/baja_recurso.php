...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $sql_select = "SELECT estatus FROM recursos WHERE pk_recurso = :id";
        ...
        if ($proyecto) {
            ...
            $sql_update = "UPDATE recursos SET estatus = :nuevo_estatus WHERE pk_recurso = :id";
            ...
            if ($stmt_update->execute()) {
                ...
                header('Location: ../../admin/lista_recursos.php?status_changed=1&message=' . urlencode($mensaje));
                exit();
            } else {
                header('Location: ../../admin/lista_recursos.php?error=update_failed');
                exit();
            }
        } else {
