            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="torneos_activos.php?tipo_torneo=1">Software</a></li>
                        <li><a class="dropdown-item" href="torneos_activos.php?tipo_torneo=2">Videojuegos</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
